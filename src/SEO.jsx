...
export default function SEO({ title }) {
        ...
        const siteDescription = 'Explore a wide range of products at Elbim. Find the latest trends in fashion, electronics, and more.';
        const siteKeywords = 'Elbim, online shopping, fashion, electronics, Uzbekistan';
        ...
        return (
            <Helmet>
                    ...
                    <meta property='og:title' content={title ? `${title} - ${siteTitle}` : siteTitle} key='ogtitle' />
